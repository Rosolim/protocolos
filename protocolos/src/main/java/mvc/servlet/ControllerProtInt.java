...
@WebServlet(value = "/pages/intProtocolo")
public class ControllerProtInt extends HttpServlet {
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse resp)
		...
		protocolo.calcNrProtInt(q1, q2, q3, q4, q5, q6, q7, q8, q9, q10, q11,
				q12);
		protocolo.setDocInt();

		req.setAttribute("numberProt", protocolo);
		req.getRequestDispatcher("showProtInt.jsp").forward(req, resp);
	}
}
