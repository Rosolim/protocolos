...
@WebServlet(value = "/pages/ctProtocolo")
public class ControllerProtCT extends HttpServlet {
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		protocolo.calcNrProtCT(q1, q2, q3, q4, q5, q6, q7, q8, q9, q10, q11, q12);
		protocolo.setDocCT();

		req.setAttribute("numberProt", protocolo);
		req.getRequestDispatcher("showProtCT.jsp").forward(req, resp);
	}
