...
<link href="fonts/css/font-awesome.min.css" rel="stylesheet"
	type="text/css">
<link
	href="fonts/css/css?family=Lato:300,400,700,300italic,400italic,700italic"
	...
	<nav class="navbar navbar-default navbar-fixed-top topnav"
		...
		<div class="container topnav">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand topnav" href="index.jsp#">Centro Integrado de Combate ao Terrorismo</a>
			</div>
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="pages/question.jsp">Pesquisa</a></li>
					<li><a href="pages/listProt.jsp">Listar Protocolos</a></li>
				...
				<div class="col-lg-12">
					<div class="intro-message">
						...
						<ul class="list-inline intro-social-buttons">
							...
							<li><a href="index.html#" class="btn btn-default btn-lg"><i
